                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal group-border hover-stripped" role="form" method="post" action="${pageContext.request.contextPath}/building/dormBuilding/save" onsubmit="return validateCallback(this, navTabAjaxDone);">
